...
@section('content')
    ...
    <section class="position-relative py-5 text-white overflow-hidden" style="background: linear-gradient(135deg, #78350f 0%, #b45309 60%, #d97706 100%);">
        <div class="position-absolute top-0 start-0 w-100 h-100 opacity-25" style="background-image: url('{{ asset('images/Peraturan.webp') }}'); background-size: cover; background-position: center;"></div>
