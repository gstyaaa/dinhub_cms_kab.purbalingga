...
@section('content')
    ...
    <section class="position-relative py-5 text-white overflow-hidden" style="background: linear-gradient(135deg, #071527 0%, #0d3b66 60%, #1e3a8a 100%);">
        <div class="position-absolute top-0 start-0 w-100 h-100 opacity-25" style="background-image: url('{{ asset('images/Program dan Kegiatan.webp') }}'); background-size: cover; background-position: center;"></div>
